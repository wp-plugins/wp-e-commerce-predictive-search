...
class WPSC_PS_Exclude_Content_Settings extends WPSC_Predictive_Search_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Exclude Content Settings successfully saved.', 'wpscps' ),
				'error_message'		=> __( 'Error: Exclude Content Settings can not save.', 'wpscps' ),
				'reset_message'		=> __( 'Exclude Content Settings successfully reseted.', 'wpscps' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Exclude Content', 'wpscps' ),
	...
	public function init_form_fields() {
		...
		if ($results_p_tags) {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Exclude From Predictive Search', 'wpscps' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Exclude Products', 'wpscps' ),
				'id' 		=> 'ecommerce_search_exclude_products',
				'type' 		=> 'multiselect',
				'placeholder' => __( 'Choose Products', 'wpscps' ),
			...
			array(  
				'name' 		=> __( 'Exclude Product Categories', 'wpscps' ),
				'id' 		=> 'ecommerce_search_exclude_p_categories',
				'type' 		=> 'multiselect',
				'placeholder' => __( 'Choose Product Categories', 'wpscps' ),
				'css'		=> 'width:600px; min-height:80px;',
				'options'	=> $all_p_categories,
			),
			array(  
				'name' 		=> __( 'Exclude Product Tags', 'wpscps' ),
				'id' 		=> 'ecommerce_search_exclude_p_tags',
				'type' 		=> 'multiselect',
				'placeholder' => __( 'Choose Product Tags', 'wpscps' ),
				'css'		=> 'width:600px; min-height:80px;',
				'options'	=> $all_p_tags,
			),
			array(  
				'name' 		=> __( 'Exclude Posts', 'wpscps' ),
				'id' 		=> 'ecommerce_search_exclude_posts',
				'type' 		=> 'multiselect',
				'placeholder' => __( 'Choose Posts', 'wpscps' ),
				'css'		=> 'width:600px; min-height:80px;',
				'options'	=> $all_posts,
			),
			array(  
				'name' 		=> __( 'Exclude Pages', 'wpscps' ),
				'id' 		=> 'ecommerce_search_exclude_pages',
				'type' 		=> 'multiselect',
				'placeholder' => __( 'Choose Pages', 'wpscps' ),
				'css'		=> 'width:600px; min-height:80px;',
				'options'	=> $all_pages,
			),
