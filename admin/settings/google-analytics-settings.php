...
class WPSC_PS_Search_Google_Analytics_Settings extends WPSC_Predictive_Search_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Google Analytics Settings successfully saved.', 'wpscps' ),
				'error_message'		=> __( 'Error: Google Analytics Settings can not save.', 'wpscps' ),
				'reset_message'		=> __( 'Google Analytics Settings successfully reseted.', 'wpscps' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Google Analytics', 'wpscps' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(
            	'name' 		=> __( 'Google Analytics Site Search Integration', 'wpscps' ),
                'type' 		=> 'heading',
           	),
			array(  
				'name' 		=> __( 'Track Predictive Search Result with Google Analytics', 'wpscps' ),
			...
			array(  
				'name' 		=> __( 'Google Analytics UID', 'wpscps' ),
				'desc' 		=> __('Example:', 'wpscps') . ' UA-3423237-10',
			...
			array(  
				'name' 		=> __( 'Query Parameter', 'wpscps' ),
				'desc' 		=> __( 'The parameter that is to be entered on the track Site Search config page on your Google Anayitics account. Default: [default_value]', 'wpscps' ),
