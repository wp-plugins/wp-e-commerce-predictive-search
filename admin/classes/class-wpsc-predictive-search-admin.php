...
class WPSC_Settings_Tab_Ps_Settings {
	...
	function predictive_extension() {
		...
		$html .= '<li>* <a href="http://a3rev.com/shop/woocommerce-email-inquiry-and-cart-options/" target="_blank">'.__('WooCommerce Email Inquiry & Cart Options', 'wpscps').'</a>'.__(' - Pro Version only from a3rev', 'wpscps').'</li>';
		$html .= '</ul>';
		$html .= '</p>';
