...
<?php
/*-----------------------------------------------------------------------------------
WPSC Predictive Search Search Function Tab
...
class WPSC_PS_Search_Function_Tab extends WPSC_Predictive_Search_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wpsc_ps_search_function_tab_manager',
		);
...
global $wpsc_ps_search_function_tab;
$wpsc_ps_search_function_tab = new WPSC_PS_Search_Function_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wpsc_ps_search_function_tab_manager() {
	global $wpsc_ps_search_function_tab;
	$wpsc_ps_search_function_tab->tab_manager();
}
