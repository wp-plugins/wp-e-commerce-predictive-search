...
<?php
/*-----------------------------------------------------------------------------------
WPSC Predictive Search Global Settings Tab
...
class WPSC_Predictive_Search_Global_Settings_Tab extends WPSC_Predictive_Search_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wpsc_predictive_search_global_settings_tab_manager',
		);
...
global $wpsc_predictive_search_global_settings_tab;
$wpsc_predictive_search_global_settings_tab = new WPSC_Predictive_Search_Global_Settings_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wpsc_predictive_search_global_settings_tab_manager() {
	global $wpsc_predictive_search_global_settings_tab;
	$wpsc_predictive_search_global_settings_tab->tab_manager();
}
