...
<?php
/*-----------------------------------------------------------------------------------
WPSC Predictive Search Exclude Content Tab
...
class WPSC_PS_Exclude_Content_Tab extends WPSC_Predictive_Search_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wpsc_ps_exclude_content_tab_manager',
		);
	...
	public function settings_include() {
		...
		include_once( $this->admin_plugin_dir() . '/settings/exclude-content-settings.php' );
...
global $wpsc_ps_exclude_content_tab;
$wpsc_ps_exclude_content_tab = new WPSC_PS_Exclude_Content_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wpsc_ps_exclude_content_tab_manager() {
	global $wpsc_ps_exclude_content_tab;
	$wpsc_ps_exclude_content_tab->tab_manager();
}
