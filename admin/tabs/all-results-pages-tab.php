...
<?php
/*-----------------------------------------------------------------------------------
WPSC Predictive Search All Results Page Tab
...
class WPSC_PS_All_Results_Page_Tab extends WPSC_Predictive_Search_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wpsc_ps_all_results_page_tab_manager',
		);
...
global $wpsc_ps_all_results_page_tab;
$wpsc_ps_all_results_page_tab = new WPSC_PS_All_Results_Page_Tab();

/** 
 * wc_admin_ei_email_popup_tab_manager()
 * Define the callback function to show tab content
 */
function wpsc_ps_all_results_page_tab_manager() {
	global $wpsc_ps_all_results_page_tab;
	$wpsc_ps_all_results_page_tab->tab_manager();
}
