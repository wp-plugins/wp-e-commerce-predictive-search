...
class WPSC_Predictive_Search_Less
{
	public $plugin_name = 'wpsc_predictive_search';
	public $css_file_name = 'wpsc_predictive_search';
	public $plugin_folder = WPSC_PS_FOLDER;
	public $plugin_dir = WPSC_PS_DIR;
...
global $wpsc_predictive_search_less;
$wpsc_predictive_search_less = new WPSC_Predictive_Search_Less();
?>
